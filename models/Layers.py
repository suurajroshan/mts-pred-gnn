...
from .SubLayers import TPGNN, WOTPG, WODynamic, WOOverview, WONormalize, WOKmatrics
...
class EncoderLayer_stamp(nn.Module):
    def __init__(
        ...
        ablation = {'TPGNN': TPGNN(n_attr, n_attr, n_route, n_his, dis_mat, kt, opt.n_c, droprate, temperature),
                    'WOTPG': WOTPG(n_attr, n_attr, n_route, n_his, dis_mat, kt, opt.n_c, droprate, temperature),
                    'WODynamic': WODynamic(n_attr, n_attr, n_route, n_his, dis_mat, kt, opt.n_c, droprate, temperature),
                    'WOOverview': WOOverview(n_attr, n_attr, n_route, n_his, dis_mat, kt, opt.n_c, droprate,
                                             temperature),
                    'WONormalize': WONormalize(n_attr, n_attr, n_route, n_his, dis_mat, kt, opt.n_c, droprate,
                                               temperature),
                    'WOKmatrics': WOKmatrics(n_attr, n_attr, n_route, n_his, dis_mat, kt, opt.n_c, droprate,
                                             temperature),
                    }

        self.stgc = ablation[opt.ablation]
